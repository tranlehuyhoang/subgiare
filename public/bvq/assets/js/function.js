...
console.log(
    "%c Coder: Bùi Văn Quyết %c",
    'font-family: "Helvetica Neue", Helvetica, Arial, sans-serif;font-size:24px;color:#00bbee;-webkit-text-fill-color:#00bbee;-webkit-text-stroke: 1px #00bbee;',
    "font-size:12px;color:#999999;"
);
console.log(
    "%c Contact: https://www.facebook.com/henk.basson1/ %c",
    'font-family: "Helvetica Neue", Helvetica, Arial, sans-serif;font-size:24px;color:#00bbee;-webkit-text-fill-color:#00bbee;-webkit-text-stroke: 1px #00bbee;',
    "font-size:12px;color:#999999;"
);
$(document).ready(function () {
    ...
    $("form[submit-ajax=bvq]").submit(function (e) {
        e.preventDefault();
        let _this = this;
