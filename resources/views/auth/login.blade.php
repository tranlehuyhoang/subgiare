<!doctype html>
<html lang="en" class="light-style  customizer-hide" dir="ltr" data-theme="theme-semi-dark" data-assets-path="{{ asset('') }}bvq/assets/" data-template="vertical-menu-template-semi-dark">
...
<head>
    ...
    <meta name="page-topic"
        content="hack like facebook, hack like, hack like ảnh facebook, tăng like facebook, tăng follow instagram,tang like instagram, hack like stt, cmt, hack like bình luận, hack sub, hack like fb" />
    <meta name="keywords"
        content="like, sub, share, vip like, buff mắt, tăng follow, mua like, mua sub, sub rẻ, hack like, hack sub, hack follow, tăng like, tăng follow, cách hack tăng like,share code auto like, xin code auto like, web auto like, " />
    ...
    <div class="authentication-inner row m-0">
      ...
      <div class="d-none d-lg-flex col-lg-7 col-xl-8 align-items-center">
        <div class="flex-row text-center mx-auto">
          <img src="{{ asset('') }}bvq/assets/images/svg/login.png" alt="Auth Cover Bg color" width="850" class="img-fluid authentication-cover-images" data-app-light-images="/svg/login.png" data-app-dark-img="/svg/login.png">
          <div class="mx-auto">
        ...
        <g id="Login" transform="translate(519.000000, 244.000000)">
          <g id="Logo" transform="translate(148.000000, 42.000000)">
            <g id="icon" transform="translate(0.000000, 4.000000)">
              ...
              <span class="app-brand-text demo h3 mb-0 fw-bold">SieuThiSub.Net</span>
            </a>
          </div>
          <!-- /Logo -->
          ...
          action="{{ route('auth.login.post') }}" method="POST">
          @csrf
                                                @if (session('error'))
                                                    <div class="alert alert-danger alert-dismissible fade show"
                                                        role="alert">
                                                        <span
                                                            class="alert-inner--text">{{ session('error') }}</span>
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="username" name="username" placeholder="Vùi Lòng Nhập Tài Khoản" autofocus>
            </div>
        ...
        function rescallback(response) {
            if (response.status === true) {
                ...
                window.location.href =
                    "{{ route('home') }}"; /* setTimeout(() => {window.location.href = "{{ route('home') }}";}, 2000); */
            } else {
                $('.rescallback').hide();
                $('#callback').html(response.data);
            }
